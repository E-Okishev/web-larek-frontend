...
- `handleResponse` - метод проверяет, успешен ли ответ. Если ответ успешен, возвращает данные в виде JSON. Если ответ неуспешен, возвращает ошибку с описанием из ответа или статусом ответа.
#### Класс EventEmitter
